...
upper_staff2 = Staff((Mm(120), Mm(160)), flowable, Mm(80), staff_group)
...
lineHOfEllipses(10, pageNum, 3, 3, 0, 0, 0, 10, 10, "#000000ff")
...
Dynamic((unit(20), unit(6.5)), upper_staff2, "mf")
Text((unit(20), unit(6.5)), upper_staff2, "molto espressivo", expressive_font)

Chordrest(unit(20), upper_staff2, ["g'"], Duration(1, 2))
Chordrest(unit(28), upper_staff2, ["f#'"], Duration(1, 1))
Chordrest(unit(36), upper_staff2, ["ab"], Duration(1, 8))
Chordrest(unit(38), upper_staff2, ["g'"], Duration(1, 1))
Chordrest(unit(46), upper_staff2, ["f#'"], Duration(1, 2))
Chordrest(unit(50), upper_staff2, ["ab"], Duration(1, 1))

Clef(Mm(80), upper_staff2, 'bass')

group = [
         Chordrest(unit(66), upper_staff2, ["a,,"], Duration(1, 16)),
         Chordrest(unit(68), upper_staff2, ["b,,"], Duration(1, 16)),
         Chordrest(unit(70), upper_staff2, ["bb,,"], Duration(1, 16)),
         Chordrest(unit(72), upper_staff2, ["c#,"], Duration(1, 16)),
         ]
...
def oneStick(xPos, yPos, length, height, color, rotation):
    #oneStick = Path((Mm(xPos), Mm(yPos)), None, "#964B00FF", rotation=0)
    oneStick = Path((Mm(xPos), Mm(yPos)), None, color, rotation=rotation)
...
# oneStick(10, 10, 15, 3, Color(165, 42, 42, 255), 76)




def manySticks(num, xMin, xMax, yMin, yMax, length, height, rgba, alphaRand, rotation, rotationRand):
    random.seed()
    for i in range(0, num):
        ...
        oneStick(xPos, yPos, length*randXLength, height*randYHeight, color, newRotation)

# Color(165, 42, 42, 255)
# num, xMin, xMax, yMin, yMax, length, height, rgba, alphaRand, rotation, rotationRand
manySticks(80, 150, 200, 100, 120, 15, 3, [165, 42, 42, 255], 0.9, 360, 0.01)
